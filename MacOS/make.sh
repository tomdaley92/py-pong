...
cp MacOS/frameworks/sdl2/libSDL2.dylib $DIST_PATH/$APP_NAME.app/Contents/Frameworks/sdl2/libSDL2.dylib
cp MacOS/resources/Info.plist $DIST_PATH/$APP_NAME.app/Contents/Info.plist 
